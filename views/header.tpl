...
%for js in ['jquery-3.3.1.min', 'md5', 'version', 'errors', 'dropdown', 'render', 'ui', 'socket', 'gm', 'music', 'utils', 'webcam', 'drawing', 'assets', 'constants']:
    <script src="/static/client/{{js}}.js?v={{engine.version}}"></script>
%end
