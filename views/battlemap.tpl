...
%end
    ...
    <div class="battlemap" id="gamecontent">
        ...
        <div id="tokenbar">
            ...
            <img src="/static/resize.png" id="tokenResize" onMouseDown="onResizeReset(event);" onDragStart="onStartResize();" onDragEnd="onQuitAction(event);" onMouseEnter="showHint(event, 'DRAG TO RESIZE');" onMouseLeave="hideHint();" />
            <img src="/static/rotate.png" id="tokenRotate" onMouseDown="onRotateReset(event);" onDragStart="onStartRotate();" onDragEnd="onQuitAction(event);" onMouseEnter="showHint(event, 'DRAG TO ROTATE');" onMouseLeave="hideHint();" />
        </div>
    </div>
