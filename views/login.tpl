    ...
    <div class="menu">
        ...
        <div class="form">
            <form onsubmit="login(event, '{{gm.url}}', '{{game.url}}', '{{websocket_url}}');">
                ...
                <p>PLAYER COLOR</p>
                <input type="color" name="playercolor" id="playercolor" value="{{playercolor}}"><img src="{{engine.adjustStaticsUrl('/static/rotate.png')}}" class="icon" title="RANDOM COLOR" onClick="pickRandomColor();" />
